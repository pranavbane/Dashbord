        ...
        <Row className="g-4 align-items-center">
          <Col lg={6}>
            ...
            >
              {mediaSlides.map((s, i) => (
                <Carousel.Item key={i}>
                  <div className="media-card" data-testid={`media-slide-${i}`}>
                    <Row>
          ...
          <Col lg={6} className="media-text-col">
            <h3>OUR PRESENCE IN MEDIA</h3>
            <h5>An authored article in Informist Media</h5>
            <p className="date">June 7, 2023</p>
            <p className="author">Mahesh Patil</p>
            <p className="mediaText">CIO of</p>
            <p className="mediaText">Aditya Birla Sun Life AMC Ltd.</p>
          </Col>
        </Row>
      </Container>
    </section >
